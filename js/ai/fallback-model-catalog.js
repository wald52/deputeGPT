export const FALLBACK_MODEL_CATALOG = {
  ...
  models: [
    ...
    },
    {
      ...
      status: 'experimental',
      default: false,
      path: 'onnx-community/gemma-4-E2B-it-ONNX',
      runtime: 'gemma4_low_level',
      modelClass: 'Gemma4ForConditionalGeneration',
      task: 'text-generation',
      estimated_download_mb: 550,
      notes: "Experimental. Gemma 4 E2B (~2 B parametres effectifs) via transformers.js + WebGPU. Repo -ONNX multimodal charge en mode texte seul. Poids comparable a Qwen3 0.6B mais a priori plus performant. Le role 'system' est fusionne dans le premier tour utilisateur si le gabarit Gemma le refuse. Tailles estimatives a confirmer. NE PAS confondre avec la variante 'qat-mobile' (ONNX Runtime natif, incompatible transformers.js).",
      non_thinking: {
        temperature: 0.7,
        top_p: 0.9,
        top_k: 64,
      ...
      quantizations: [
        { id: 'q4f16', name: 'Q4F16', dtype: 'q4f16', estimated_download_mb: 550, default: true },
        { id: 'q4', name: 'Q4', dtype: 'q4', estimated_download_mb: 800 },
        { id: 'fp16', name: 'FP16', dtype: 'fp16', estimated_download_mb: 2000 }
      ]
    },
    {
      id: 'gemma4-e4b',
      ...
      status: 'experimental',
      default: false,
      path: 'onnx-community/gemma-4-E4B-it-ONNX',
      runtime: 'gemma4_low_level',
      modelClass: 'Gemma4ForConditionalGeneration',
      task: 'text-generation',
      estimated_download_mb: 1500,
      notes: "Experimental, profil lourd (~4 B parametres effectifs) via transformers.js + WebGPU. Repo -ONNX multimodal charge en mode texte seul. Plus capable que Gemma 4 E2B mais nettement plus lourd ; reserve aux machines solides. Le role 'system' est fusionne dans le premier tour utilisateur si le gabarit Gemma le refuse. Tailles estimatives a confirmer. NE PAS confondre avec la variante 'qat-mobile' (ONNX Runtime natif, incompatible transformers.js).",
      non_thinking: {
        temperature: 0.7,
        top_p: 0.9,
        top_k: 64,
      ...
      quantizations: [
        { id: 'q4f16', name: 'Q4F16', dtype: 'q4f16', estimated_download_mb: 1500, default: true },
        { id: 'q4', name: 'Q4', dtype: 'q4', estimated_download_mb: 2100 },
        { id: 'fp16', name: 'FP16', dtype: 'fp16', estimated_download_mb: 5000 }
      ]
    }
  ]
};

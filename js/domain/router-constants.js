...
export const THEME_KEYWORDS = {
  ecologie: ['ecologie', 'écologie', 'ecologique', 'écologique', 'ecolo', 'écolo', 'ecologiste', 'écologiste', 'environnement', 'climat', 'carbone', 'biodiversite', 'biodiversité', 'transition energetique', 'transition énergétique', 'transition ecologique', 'transition écologique', 'pollution de l air', 'qualite de l air', 'qualité de l air', 'nuisances locales', 'pfas', 'emissions de co2', 'émissions de co2', 'jets prives', 'jets privés'],
  ...
  sante: ['sante', 'santé', 'hopital', 'hôpital', 'medecin', 'médecin', 'securite sociale', 'sécurité sociale', 'hopitaux', 'hôpitaux', 'ald', 'arret maladie', 'arrêt maladie', 'deserts medicaux', 'déserts médicaux', 'cannabis therapeutique', 'cannabis thérapeutique', 'protections periodiques', 'protections périodiques', 'medicament', 'médicament', 'medicaments', 'médicaments', 'remboursement des medicaments', 'remboursement des médicaments'],
  agriculture: ['agriculture', 'agricole', 'agricoles', 'agriculteur', 'agriculteurs', 'foncier agricole', 'paysans', 'acetamipride', 'acétamipride', 'loi duplomb', 'duplomb'],
  budget: ['budget', 'budgets', 'budgetaire', 'budgétaire', 'budgetaires', 'budgétaires', 'finances', 'fiscal', 'fiscalite', 'fiscalité', 'fiscalisation', 'impot', 'impôts', 'taxe', 'taxes', 'surtaxe', 'plf', 'plfss', 'csg', 'revenus du capital', 'hauts revenus', 'haut revenu', 'patrimoine', 'patrimoines', 'budget de l etat', 'budget de l état', 'budget de l\'etat', 'pouvoir d achat', 'pouvoir d’achat', 'inflation', 'menages modestes', 'ménages modestes', 'menages les plus modestes', 'ménages les plus modestes', 'classes moyennes', 'indemnites journalieres', 'indemnités journalières', 'services publics'],
  ...
  education: ['education', 'éducation', 'ecole', 'école', 'universite', 'université', 'eleve', 'élève', 'harcelement scolaire', 'harcèlement scolaire', 'jeunesse', 'jeunes', 'etudiants', 'étudiants', 'apprentis', 'mineurs', 'decrochage scolaire', 'décrochage scolaire', 'bourses etudiantes', 'bourses étudiantes', 'enseignement public', 'etablissements scolaires', 'établissements scolaires', 'mixite sociale', 'mixité sociale'],
  ...
  institutions: ['assemblee', 'assemblée', 'democratie', 'démocratie', 'proportionnelle', 'referendum', 'référendum', 'vote assis et leve', 'vote assis et levé', 'hémicycle', 'hemicycle', 'vote obligatoire', 'participation citoyenne', 'decentralisation', 'pantouflage', 'parite', 'parité', 'amendements de l opposition', 'amendements deposes par l opposition', 'amendements déposés par l opposition', 'opposition parlementaire'],
  economie: ['commerce', 'commercial', 'commerciale', 'economie', 'économie', 'economique', 'économique', 'entreprise', 'entreprises', 'pme', 'industrie', 'croissance', 'consommation', 'reindustrialisation', 'intéressement', 'interessement', 'partage de la valeur', 'urgence economique', 'urgence économique', 'urgences economiques', 'urgences économiques', 'urgences economiques et sociales', 'urgences économiques et sociales'],
